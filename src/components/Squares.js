...
const [squares, setSquares] = useState(lisOfSquareIds)
//slices of state for active squares
const [activeSquare, setActiveSquare] = useState(null)
  ...
  const getClassName = id => {
    ...
    if (id === activeSquare){
      return 'active' //if id equals activeSquare add class active
    } else { //otherwise
      return '' //return an active string
    }
  };
