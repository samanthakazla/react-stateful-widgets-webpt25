...
const initialMood = 'Not sure how I feel';//initial state
const happyMood = 'Quite happy!';//happy state
const sadMood = 'Rather sad';//sad state

export default function Moods() {
  /* STEP 1 */
  //set state for the mood
  ...
  return (
    <div className='widget-moods container'>
      <h2>Moods</h2>
      <div id='mood' style={style} mood={initialMood}>{mood} </div>
      <div>
